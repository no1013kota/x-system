...
- プレミアムは契約期間（更新日〜次の更新日・T-M8-258）ごとに通常投稿200件、URL付き投稿20件、AIクレジット1000（文章・画像のAI実行が金額で消費する。T-M8-109で回数制から移行）。投稿作成成功はtweet_id単位で該当枠を1消費し、ロールバック削除成功は元投稿と同じ枠をさらに1消費するため、作成と削除で合計2消費となる。
