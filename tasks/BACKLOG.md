...
| 要決定 | **1件（D-19 のみ）**。**2026-08-20 に D-16（stgはPR必須なしの保護）・D-17（法務レビュー不要）・D-18（案A 本人の同意）・D-20（退会手順は対応しない）・D-29（案B 現状維持）を解決**。D-21〜D-26 は 2026-08-11、D-30 は 2026-08-16、D-27・D-28 は 2026-08-17 に解決済み。**D-19 は T-M8-162 で見える化済み → 運営者が本番のSentry設定を確認して決める** | 「要決定・外部準備」 |
