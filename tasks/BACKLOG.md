...
| 要決定 | **9件**（D-16 / D-17 / D-18 / D-19 / D-20 / **D-27** / **D-28** / **D-29** / **D-30**）。D-21〜D-26 は 2026-08-11 に解決済み | 「要決定・外部準備」 |
...
### T-M8-109: 生成・画像クレジットを「AIクレジット」（金額制・1000=1000円分）へ統合する `todo`
