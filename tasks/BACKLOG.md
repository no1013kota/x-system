...
### T-M8-405: プロンプト画面の区分の先頭を「AIモデル設定」にする `todo`
...
### T-M8-406: プロンプト＞アカウント.md の5項目フォームに「自由入力でアカウント設定を作る」の見出しを置く `todo`
...
### T-M8-408: ニュースの取得・通知の時刻の文言を実態（10分おき巡回・新着があった時間帯に1回）へ直す `todo`
