...
### T-M8-206: 通知の既定をメール3種（ニュース・投稿完了・毎日のまとめ）へ `todo`
...
### T-M8-208: 設定＞プロンプトにもプレースホルダー説明カラウトを表示 `todo`
...
### T-M8-211: Stripe Productの説明文を現行プランへ更新（決済画面の旧文言） `todo`
