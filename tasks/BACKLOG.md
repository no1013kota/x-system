...
| 要決定 | **4件**（D-16 / D-18 / D-19 / **D-29**）。**D-17（法務レビュー＝不要）と D-20（退会手順＝対応しない）は 2026-08-20 に運営者判断で解決**。D-21〜D-26 は 2026-08-11、D-30 は 2026-08-16、D-27・D-28 は 2026-08-17 に解決済み。**D-19 は先に T-M8-162 が必要**（Sentryが受け取っているかが未確認） | 「要決定・外部準備」 |
...
### T-M8-162: Sentryが実際にイベントを受け取っているかを運営者が確認できるようにする `todo`
