 ...
 *   「月額（税込）÷30日の目安」の行は運営者の指示（2026-09-05・T-M8-431）で削除した——換算の根拠は
 *   直下のカードの月額と対で読める。カード側の「1日あたり」行はキャップが持つので CSS module で消す。
 * - 数字の大きさは推奨だけ 40px、両隣は 28px（同格に並べると左→右の読み順で最安の数字が最初に
 *   目に入り、帯の「まずはこれ」の錨が左へ引かれる）。「まずはこれ」は text-sm・白。
