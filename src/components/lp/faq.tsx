 ...
 * 暗号化・末尾4桁は「04 安全性」、トライアルの条件は申込前確認事項が正の置き場所。
...
const FAQ_ITEMS: [question: string, answer: string][] = [
  [
    "APIキーとは何ですか？",
    "Xや生成AIのサービスを利用するための「鍵」となる文字列です。通常プラン・mdプランではご自身でご用意いただき、月額とは別に各提供元の利用料がかかります。プレミアムプランでは運営が用意するため不要です。",
  ],
  [
    "勝手に投稿されませんか？",
    "されません。既定は「下書きまで」モードで、自動投稿には画面での明示的な同意が別途必要です。Xと連携しただけでは始まりません。",
  ],
  [
    "解約はいつでもできますか？",
