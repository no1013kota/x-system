...
export const authInputClassName =
  "h-11 w-full rounded-card border border-hairline bg-surface px-3 text-[14px] outline-none transition-colors duration-150 focus-visible:border-brand focus-visible:ring-3 focus-visible:ring-brand/15";
