  ...
  const items = [
    ...
    },
    {
      ...
      description:
        ...
        (premium
          ? `${PLANS.premium.displayName}には契約期間（お支払いの更新日から次の更新日まで）ごとの利用枠（通常投稿クレジット${premium.normalPosts}・URL付き投稿クレジット${premium.urlPosts}・AIクレジット${premium.aiCredits}〔AIの実行はモデルと内容に応じた量を消費〕）があります。使い残した分は次の契約期間へ繰り越されません。無料トライアル期間中の利用分は、トライアル終了後の最初の契約期間の利用枠に含まれます。`
          : "") +
