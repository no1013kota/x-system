  ...
  return (
    <main className="mx-auto w-full max-w-3xl space-y-8 px-5 py-12">
      ...
      <section className="space-y-4 leading-7">
        ...
        <h2 className="text-xl font-semibold">プレミアムプラン利用枠の見直し</h2>
        <p>
          プレミアムプランの月間利用枠（通常投稿・URL付き投稿・生成・画像の各上限）は、外部APIの原価や運用状況に応じて改定する場合があります。利用者に不利益となる変更を行う場合は、事前に合理的な方法で通知します。
        </p>
