...
/**
 * 旧LP（T-M8-420・2026-09-04 に `/old` へ退避。新LPが `/` に昇格）。比較用に残すだけなので
 * noindex にし、入口ファネルの閲覧計測（recordPageView）も呼ばない。削除の判断は運営者。
 */
export const metadata: Metadata = {
  title: `${APP_NAME} — AIで学習・生成・投稿・分析まで自動化するX運用アプリ（旧LP）`,
