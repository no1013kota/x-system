...
const PROBLEMS: [string, string][] = [
  ...
  [
    "AIに書かせると、自分の文章ではなくなる",
    "汎用のAIチャットは毎回こまかい指示が必要なうえ、文体も一定しません。予約投稿ツールは、投稿を作るところまでは手伝ってくれません。",
  ],
];
...
const HOW_TO_STEPS: [string, string][] = [
  ...
  ["初期設定", "Xアカウントの連携と発信設定。画面の案内に沿って、任意の順で進められます。"],
            ...
            <div>
              ...
              <div>
                ...
                <div className="mt-[22px] flex flex-wrap gap-x-[18px] gap-y-2 text-caption text-ink-2">
                  {["高品質な投稿を自動作成", "融通の効くスケジュール設定", `月額${startingPrice}から`].map(
                    (item) => (
